...
- (void)testPTColor_colorWithHex
{
    UIColor* testColor = [UIColor whiteColor];
    UIColor* color = [UIColor colorWithHex:0xffffffff];
    
    CGFloat testRed = 0.0;
    CGFloat testGreen = 0.0;
    CGFloat testBlue = 0.0;
    CGFloat testAlpha = 0.0;
    
    BOOL testConverted = [testColor getRed:&testRed green:&testGreen blue:&testBlue alpha:&testAlpha];
    
    XCTAssertTrue(testConverted, @"testColor converting failed");
    ...
    XCTAssertTrue(converted, @"color converting failed");
    
    XCTAssertEqual(testRed, red, @"%f != %f",testRed,red);
    XCTAssertEqual(testGreen, green, @"%f != %f",testGreen,green);
    XCTAssertEqual(testBlue, blue, @"%f != %f",testBlue,blue);
    XCTAssertEqual(testAlpha, alpha, @"%f != %f",testAlpha,alpha);
