#
#  Be sure to run `pod spec lint PopperTools.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "Henrique Sasaki Yuya" => "es.moriturus@icloud.com", "other author" => "email@address.com" }
  # s.author           = 'Henrique Sasaki Yuya', 'other author'
  # s.social_media_url = "http://twitter.com/Henrique Sasaki Yuya"
  ...
  s.source       = { :git => "https://github.com/moriturus/PopperTools.git", :tag => "2.2.1" }
  ...
  s.source_files  = 'PopperTools', 'PopperTools/*.{h,m}'
